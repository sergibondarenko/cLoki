...
export function Alert () {
  ...
  const doUpdate = params?.alertName
  ...
  function handleAddAlert (alert, { setSubmitting } = {}) {
    const navigateTo = ROUTE_PATH.ALERTS
    if (doUpdate) updateAlert(alert, { navigateTo, setSubmitting })
    else addAlert(alert, { navigateTo, setSubmitting })
  }
